...
class Planner:
    ...
    def euclidean_distance(self,x2,y2,z2,x1,y1,z1):
        return math.sqrt((x2-x1)**2 + (y2-y1)**2 + (z2-z1)**2)

    def find_neighbors(self, tree, x, y, z, neighborhood_radius):
    ...
    def find_best_node(self, tree, current_node, grid, neighborhood_radius):
    ...
    def update_child_nodes(self, node):
        ...
        for child in node.children:
            ...
            child.g = node.g + self.euclidean_distance(
                node.x,
                node.y,
                node.z,
                child.x,
            ...
            self.update_child_nodes(child)



    def update_neighborhood(self, neighborhood, new_node, grid):
        ...
        for node, d in neighborhood:
            ...
            if tentative_g < node.g:
                ...
                if not self.check_for_obstacles(
                    ...
                    self.update_child_nodes(node)



    def check_for_obstacles(self, node1, node2, grid):
    ...
    def rrt(self,
        ...
        self.tree = [
            Node(start_x, start_y, start_z, g=0)
        ]
        ...
        for i in range(max_iter):
            ...
            x_new = (
                nearest_node.x +
                step_size * direction[0]
            )

            y_new = (
                nearest_node.y +
                step_size * direction[1]
            )
            ...
            new_node = Node(
                ...
                nearest_node.g +
                self.euclidean_distance(nearest_node.x,nearest_node.y,nearest_node.z,x_new,y_new,z_new),
                parent=nearest_node
            ...
            neighborhood = self.find_neighbors(
            ...
            new_node.parent.children.append(
                new_node
            )
            ...
            dist_to_goal = self.euclidean_distance(
                x_new,
                y_new,
                z_new,
                goal_x,
